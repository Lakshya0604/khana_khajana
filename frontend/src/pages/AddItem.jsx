            ...
            <div className='max-w-lg w-full bg-white shadow-xl rounded-2xl p-8 border border-orange-100'>
                <div className='flex flex-col items-center mb-6'>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <button type='submit' className='w-full bg-[#ff4d2d] mt-4 text-white px-5 sm:px-6 py-2 rounded-full font-medium shadow-md hover:bg-orange-500 transition-colors duration-200 cursor-pointer' disabled={loading}>{loading ? <ClipLoader size={20} color='white' /> : "Save"}</button>
                    </form>
                </div>
            </div>
        </div>
